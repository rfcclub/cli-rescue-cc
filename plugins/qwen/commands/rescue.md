---
description: Delegate investigation or implementation to the Qwen Code agent (free tier)
...
Operating rules:
- The subagent makes one `Bash` call to `qwen-companion.mjs task ...` and returns stdout as-is.
